...
class BackupRestoreBottomSheetFragment: BaseBottomSheetFragment<FragmentBottomSheetBackupRestoreBinding>(FragmentBottomSheetBackupRestoreBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            binding.backupRestoreRestore.backgroundTintList = ColorStateList.valueOf(cardBg)
            binding.backupRestoreBackup.backgroundTintList = ColorStateList.valueOf(cardBg)
